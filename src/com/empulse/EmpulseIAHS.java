...
public class EmpulseIAHS {
	...
	public static void main(String[] args) {
		...
		try {
			String url = "https://www.empulseudp.com/IAHS/";
			Date datestart = new Date();
			driver.get(url);
			String beforelogin = driver.getPageSource();
			DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
			FileWriter fw = new FileWriter("test1(IAHS)_log.txt", true);
			...
			if (driver.getTitle().contains("404") || beforelogin.contains("Access Denied")) {
				...
				driver.findElement(By.xpath("//input[@value='Username']")).sendKeys("sherlin.thomas@empulseglobal.com");
